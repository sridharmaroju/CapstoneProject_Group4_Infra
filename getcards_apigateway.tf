...
resource "aws_api_gateway_resource" "getCards" {
...
# # POST method
resource "aws_api_gateway_method" "getCards_post" {
...
resource "aws_api_gateway_integration" "getCards_integration" {
  rest_api_id             = aws_api_gateway_rest_api.api.id
  resource_id             = aws_api_gateway_resource.getCards.id
...
resource "aws_api_gateway_integration" "getCards_options_mock" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.getCards.id
  http_method = aws_api_gateway_method.getCards_options.http_method
  type        = "MOCK"
...
resource "aws_api_gateway_method_response" "getCards_options_response_200" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.getCards.id
  http_method = aws_api_gateway_method.getCards_options.http_method
  status_code = "200"
...
resource "aws_api_gateway_integration_response" "getCards_options_integration_response" {
  rest_api_id = aws_api_gateway_rest_api.api.id
  resource_id = aws_api_gateway_resource.getCards.id
  http_method = aws_api_gateway_method.getCards_options.http_method
  status_code = aws_api_gateway_method_response.getCards_options_response_200.status_code
...
# Lambda permission
resource "aws_lambda_permission" "apigw_getCards" {
  statement_id  = "AllowAPIGatewayInvokeGetCards"
  action        = "lambda:InvokeFunction"
  function_name = aws_lambda_function.getCards_lambda.function_name
